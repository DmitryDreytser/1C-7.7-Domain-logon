...
type
  ...
  protected
    ...
    procedure CopyMoveElement(const srcname, dstname: string;
      Dst: TStorage; flag: longint);
  ...
  public
    ...
    constructor Create(Name: string; ParentStorage: TStorage;
      AccessMode: TAccessMode; TransactMode: TTransactMode; CreateNew: boolean);
